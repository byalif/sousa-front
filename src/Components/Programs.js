...
const Programs = () => {
  ...
  const history = useNavigate(); // Get history object from useHistory // Array of product items
              ...
              <div key={product.id} className="col">
                <div style={{ width: "100%" }} className="box ">
                  ...
                  <button
                    style={{ width: "100%" }}
                    className="btn"
                    onClick={() => buyNow(product.id)} // Call buyNow function with product ID on button click
                  >
                    Buy Now
                  </button>
                </div>
